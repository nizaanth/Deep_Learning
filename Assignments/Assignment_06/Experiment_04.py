...
import models_unet
import data_generator_deeplab_augmented
import losses
...
reload(models_unet)
reload(data_generator_deeplab_augmented)
reload(losses)

from utils import *
from models_deeplab import *
from models_unet import *
from data_generator_augmented import *
from losses import *
...
cb_autosave = ModelCheckpoint("ISPRS_semantic_labeling_Vaihingen_deeplab_exp4.keras",
                              mode="max",
                              save_best_only=True,
                              monitor="val_miou",
                              verbose=1)
...
wandb.init(
    ...
    name="Semantic Segmantation - Experiment 4 ",
