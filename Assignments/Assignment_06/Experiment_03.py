...
reload(models_unet)
reload(data_generator_deeplab)
reload(losses)

from utils import *
from models_deeplab import *
from models_unet import *
from data_generator_deeplab import *
from losses import *
...
deeplab = get_unet(img_size=PATCH_SIZE,
                n_classes=n_classes)
...
### MODEL - Deeplab Callbacks ###
# Callbacks
wandb.login(key=WANDB_KEY)
cb_autosave = ModelCheckpoint("ISPRS_semantic_labeling_Vaihingen_deeplab_no_aug.keras",
                              mode="max",
                              save_best_only=True,
                              monitor="val_miou",
                              verbose=1)
...
wandb.init(
    ...
    name="Semantic Segmantation - Experiment 3 ",
